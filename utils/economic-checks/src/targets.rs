...
impl GasUsageStats {
    fn new(total_gas: u64, accounted_gas: u64, total_balance: u128, initial_balance: u128) -> Self {
        Self {
...
pub fn simple_target(params: &Params) -> TargetOutcome {
    if let Params::Simple(params) = params {
        ...
        ext.execute_with(|| {
            ...
            log::debug!(
                "[simple_target] num_contracts: {}, programs_ids: {:?}, non_program_ids: {:?}",
                contracts.len(),
                program_ids,
                non_program_ids
            );
            ...
            log::debug!(
                "[simple_target] Queue: num entries = {}, num blocks = {}, queue: {:?}",
                queue_len,
                queue.len(),
                queue,
            );
            ...
            run_to_block_with_ocw((current_block + 10) as u32, pool.clone(), None);
...
mod tests {
    ...
    fn run_target_with_params() {
        ...
        run_target(&crate::Params::Simple(params), simple_target);
    }
}
